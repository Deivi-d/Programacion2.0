...
public class proyecto_primertrimestre {
	...
	//Si no se mira que no exista una mina con la misma posición, si ya existe se resta una a i y no se guarda la actual mina para evitar generar duplicidades
